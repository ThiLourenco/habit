    ...
    <div className='w-full max-w-3xl max-auto flex item-center justify-between'>
      ...
      <Dialog.Root>
        ...
        <Dialog.Portal>
          ...
          >
            <Dialog.Close className='absolute right-6 top-6 rounded-lg text-zinc-400 houver:text-zinc-200 focus:outline-none focus:ring-2 focus:ring-violet-700 focus:ring-offset-2 focus:ring-offset-zinc-900'>
